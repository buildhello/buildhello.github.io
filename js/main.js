...
var nav_insert = function() {
//function scroll past top
...
$('#ph_1').css('display','none');
$('#ph_number_2').css('display','block');}
else {
$('#ph_1').css('display','inline');
$('#ph_number_2').css('display','none');}
});   // end subnav scrollpast top fucntion
// Click outside of offcanvass
 ...
 };//end Click outside of offcanvass
